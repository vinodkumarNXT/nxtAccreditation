import { ConsultancyProjectViewComponent } from './consultancy-project-view/consultancy-project-view.component';
...
import { TablePaginationService,ConsultancyProjectAddComponent, ConsultancyProjectEditComponent } from 'shared-lib';
import Swal from 'sweetalert2';

@Component({
  selector: 'lib-consultancy-project-details',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  providers: [FormsService, provideNativeDateAdapter()],
  templateUrl: './consultancy-project-details.component.html',
  styleUrl: './consultancy-project-details.component.css'
})
export class ConsultancyProjectDetailsComponent {
