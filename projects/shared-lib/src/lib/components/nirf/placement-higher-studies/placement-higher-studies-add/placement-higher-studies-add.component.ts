...
@Component({
  selector: 'lib-placement-higher-studies-add',
  standalone: true,
 imports: [MaterialModule, SharableModule],
  providers: [FormsService, provideNativeDateAdapter()],
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './placement-higher-studies-add.component.html',
  styleUrl: './placement-higher-studies-add.component.css'
})
export class PlacementHigherStudiesAddComponent {
...
addYearSet(): void {
  const yearGroup = this.fb.group({
    ...
    firstYearIntake: ['', [Validators.required, Validators.min(0)]],
    firstYearAdmitted: ['', [Validators.required, Validators.min(0)]],
    lateralEntryAdmitted: ['', [Validators.required, Validators.min(0)]],
    graduatingInTime: ['', [Validators.required, Validators.min(0)]],
    studentsPlaced: ['', [Validators.required, Validators.min(0)]],
    medianSalary: ['', [Validators.required, Validators.min(0)]],
    higherStudies: ['', [Validators.required, Validators.min(0)]],
  });
  ...
  this.dynamicYears.push(yearGroup);
    ...
    async submitForm(val:any) {
      ...
      console.log(" form   PG ", this.form.value);
      console.log("form   UG ", this.pgForm.value);
