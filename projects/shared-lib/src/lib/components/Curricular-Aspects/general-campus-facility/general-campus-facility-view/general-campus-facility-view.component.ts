...
@Component({
  selector: 'lib-general-campus-facility-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './general-campus-facility-view.component.html',
  styleUrl: './general-campus-facility-view.component.css'
})
export class GeneralCampusFacilityViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.GeneralCampusFacility);
