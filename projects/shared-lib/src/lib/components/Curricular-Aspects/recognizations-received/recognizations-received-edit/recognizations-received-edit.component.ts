...
@Component({
  selector: 'lib-recognizations-received-edit',
  standalone: true,
  ...
  templateUrl: './recognizations-received-edit.component.html',
  styleUrl: './recognizations-received-edit.component.css'
})
export class RecognizationsReceivedEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      awardAgencyName: ['', Validators.required],
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        ...
        awardAgencyName: this.form.get("awardAgencyName")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.RecognizationsReceived);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.RecognizationsReceived);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          awardName: formData?.award_name || '',
          awardAgencyName: formData?.award_agency_name || '',
          year: formData?.year || '',
