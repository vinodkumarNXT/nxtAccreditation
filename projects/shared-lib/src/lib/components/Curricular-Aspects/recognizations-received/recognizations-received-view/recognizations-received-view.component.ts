...
@Component({
  selector: 'lib-recognizations-received-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './recognizations-received-view.component.html',
  styleUrl: './recognizations-received-view.component.css'
})
export class RecognizationsReceivedViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.RecognizationsReceived);
