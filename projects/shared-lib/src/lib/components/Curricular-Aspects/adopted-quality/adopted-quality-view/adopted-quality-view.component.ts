...
@Component({
  selector: 'lib-adopted-quality-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './adopted-quality-view.component.html',
  styleUrl: './adopted-quality-view.component.css'
})
export class AdoptedQualityViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.AdoptedQuality);
