...
@Component({
  selector: 'lib-student-computer-ratio-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './student-computer-ratio-view.component.html',
  styleUrl: './student-computer-ratio-view.component.css'
})
export class StudentComputerRatioViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.StudentComputerRatio);
