...
@Component({
  selector: 'lib-student-computer-ratio-edit',
  standalone: true,
  ...
  templateUrl: './student-computer-ratio-edit.component.html',
  styleUrl: './student-computer-ratio-edit.component.css'
})
export class StudentComputerRatioEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      computerCount: ['', Validators.required],
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        computerCount: this.form.get("computerCount")?.value,
        studentCount: this.form.get("studentCount")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.StudentComputerRatio);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.StudentComputerRatio);
