...
@Component({
  selector: 'lib-student-computer-ratio-add',
  standalone: true,
  ...
  templateUrl: './student-computer-ratio-add.component.html',
  styleUrl: './student-computer-ratio-add.component.css'
})
export class StudentComputerRatioAddComponent {
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.StudentComputerRatio);
