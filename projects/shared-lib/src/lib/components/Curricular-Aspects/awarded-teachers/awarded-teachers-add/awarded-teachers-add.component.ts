...
@Component({
  selector: 'lib-awarded-teachers-add',
  standalone: true,
  ...
  templateUrl: './awarded-teachers-add.component.html',
  styleUrl: './awarded-teachers-add.component.css'
})
export class AwardedTeachersAddComponent {
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.AwardedTeachers);
