...
@Component({
  selector: 'lib-awarded-teachers-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './awarded-teachers-view.component.html',
  styleUrl: './awarded-teachers-view.component.css'
})
export class AwardedTeachersViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.AwardedTeachers);
