...
@Component({
  selector: 'lib-e-content-facilities-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './e-content-facilities-view.component.html',
  styleUrl: './e-content-facilities-view.component.css'
})
export class EContentFacilitiesViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.EcontentFacilities);
