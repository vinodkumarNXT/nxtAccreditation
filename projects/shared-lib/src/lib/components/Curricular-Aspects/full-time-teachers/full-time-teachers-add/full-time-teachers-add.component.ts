...
@Component({
  selector: 'lib-full-time-teachers-add',
  standalone: true,
  ...
  templateUrl: './full-time-teachers-add.component.html',
  styleUrl: './full-time-teachers-add.component.css'
})
export class FullTimeTeachersAddComponent {
...
// }
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.FullTimeTeachers);
