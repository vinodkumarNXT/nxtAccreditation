...
@Component({
  selector: 'lib-full-time-teachers-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './full-time-teachers-view.component.html',
  styleUrl: './full-time-teachers-view.component.css'
})
export class FullTimeTeachersViewComponent {
