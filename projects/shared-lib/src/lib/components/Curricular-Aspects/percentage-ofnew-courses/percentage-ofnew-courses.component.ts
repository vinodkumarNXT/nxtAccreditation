...
import { SpinnerService, TablePaginationService, SnackbarService, FormsService, PercentageofProgramsAddComponent, PercentageofProgramsEditComponent, MaterialModule, SharableModule,  YearMonthDayPipe, PercentageOfnewCoursesAddComponent, PercentageOfnewCoursesEditComponent, PercentageOfnewCoursesViewComponent } from 'shared-lib';
