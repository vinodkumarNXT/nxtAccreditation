...
@Component({
  selector: 'lib-percentage-ofnew-courses-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './percentage-ofnew-courses-view.component.html',
  styleUrl: './percentage-ofnew-courses-view.component.css'
})
export class PercentageOfnewCoursesViewComponent {
