...
@Component({
  selector: 'lib-percentage-ofnew-courses-add',
  standalone: true,
  ...
  templateUrl: './percentage-ofnew-courses-add.component.html',
  styleUrl: './percentage-ofnew-courses-add.component.scss'
})
export class PercentageOfnewCoursesAddComponent {
  ...
  //     try {
  //       const response = await this.formsService.onFormSubmit(postData, endpoints.AcaFxPercentageCourses);
