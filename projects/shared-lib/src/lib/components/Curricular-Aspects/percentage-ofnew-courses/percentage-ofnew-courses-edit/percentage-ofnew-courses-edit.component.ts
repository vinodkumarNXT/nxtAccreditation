...
@Component({
  selector: 'lib-percentage-ofnew-courses-edit',
  standalone: true,
  ...
  templateUrl: './percentage-ofnew-courses-edit.component.html',
  styleUrl: './percentage-ofnew-courses-edit.component.scss'
})
export class PercentageOfnewCoursesEditComponent {
  ...
  async updateForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        ...
        const response = await this.formsService.getFormData(this.data.id, endpoints.AcaFxPercentageCourses);
  ...
  async loadFormData() {
    try {
      const formData = await this.formsService.getFormData(this.data.id, endpoints.AcaFxPercentageCourses);
