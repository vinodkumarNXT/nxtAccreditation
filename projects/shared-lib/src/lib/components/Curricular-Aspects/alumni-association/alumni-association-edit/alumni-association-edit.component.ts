...
@Component({
  selector: 'lib-alumni-association-edit',
  standalone: true,
  ...
  templateUrl: './alumni-association-edit.component.html',
  styleUrl: './alumni-association-edit.component.css'
})

export class AlumniAssociationEditComponent {
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        alumniAssociationText: this.form.get("alumniAssociation")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.AlumniAssociation);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.AlumniAssociation);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          alumniAssociation: formData?.alumniAssociationText || '',
