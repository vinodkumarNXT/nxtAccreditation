...
@Component({
  selector: 'lib-alumni-association-add',
  standalone: true,
  ...
  templateUrl: './alumni-association-add.component.html',
  styleUrl: './alumni-association-add.component.css'
})
export class AlumniAssociationAddComponent {
    ...
    async submitForm() {
      ...
      if (this.form.valid) {
        ...
        try {
          const response = await this.formsService.onFormSubmit(postData, endpoints.AlumniAssociation);
