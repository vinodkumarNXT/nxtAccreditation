...
@Component({
  ...
  templateUrl: './alumni-association.component.html',
  styleUrl: './alumni-association.component.css'
})
export class AlumniAssociationComponent {


  pageSizeOptions: number[] = [];
  displayedColumns = ["id", "alumniAssociation","actions"];

//   {
//     "id": 1,
//     "alumniAssociationText": "testttttttt",
//     "uploadFiles": [
//         "1726808617_Screenshot_(8).png",
//         "1726808617_Screenshot_(8).png"
//     ],
//     "documentLinks": null
// }
  ...
  async loadFormData() {
    try {
      const listData = await this.formsService.getListData(endpoints.AlumniAssociation);
  ...
  openAddDialog(): void {
    // Open the dialog 
    const dialogRef = this.dialog.open(AlumniAssociationAddComponent, {});
  ...
  viewElement(val: any): void {
    ...
    const dialogRef = this.dialog.open(AlumniAssociationViewComponent, {
  ...
  async editElement(val: any): Promise<void> {
    ...
    const dialogRef = this.dialog.open(AlumniAssociationEditComponent, {
  ...
  async deleteElement(val: any): Promise<void> {
    const id = val.id;
    const endpoint = endpoints.AlumniAssociation;
