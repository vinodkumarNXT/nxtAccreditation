...
@Component({
  selector: 'lib-student-grievances-edit',
  standalone: true,
  ...
  templateUrl: './student-grievances-edit.component.html',
  styleUrl: './student-grievances-edit.component.css'
})
export class StudentGrievancesEditComponent {
