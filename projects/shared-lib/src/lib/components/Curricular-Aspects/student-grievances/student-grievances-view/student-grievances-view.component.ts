...
@Component({
  selector: 'lib-student-grievances-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './student-grievances-view.component.html',
  styleUrl: './student-grievances-view.component.css'
})
export class StudentGrievancesViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.StudentGrievances);
