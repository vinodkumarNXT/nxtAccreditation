...
@Component({
  selector: 'lib-it-facilities-add',
  standalone: true,
  ...
  templateUrl: './it-facilities-add.component.html',
  styleUrl: './it-facilities-add.component.css'
})
export class ITFacilitiesAddComponent {
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.ITFacilities);
