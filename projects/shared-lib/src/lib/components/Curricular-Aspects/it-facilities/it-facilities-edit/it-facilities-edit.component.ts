...
@Component({
  selector: 'lib-it-facilities-edit',
  standalone: true,
  ...
  templateUrl: './it-facilities-edit.component.html',
  styleUrl: './it-facilities-edit.component.css'
})
export class ITFacilitiesEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      itFacility: ['', Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        itFacility: this.form.get("itFacility")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.ITFacilities);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.ITFacilities);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          itFacility: formData?.itFacility || '',
