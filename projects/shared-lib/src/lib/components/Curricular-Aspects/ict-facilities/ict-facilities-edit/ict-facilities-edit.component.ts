...
@Component({
  selector: 'lib-ict-facilities-edit',
  standalone: true,
  ...
  templateUrl: './ict-facilities-edit.component.html',
  styleUrl: './ict-facilities-edit.component.css'
})
export class ICTFacilitiesEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      lcdCount: ['', Validators.required],
      wifiCount: ['', Validators.required],
      seminarHallCount: ['', Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        lcdCount: this.form.get("lcdCount")?.value,
        wifiCount: this.form.get("wifiCount")?.value,
        seminarHallCount: this.form.get("seminarHallCount")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.ICTFacilities);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.ICTFacilities);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          lcdCount: formData?.lcdCount || '',
          wifiCount: formData?.wifiCount || '',
          seminarHallCount: formData?.seminarHallCount || '',
