...
@Component({
  selector: 'lib-ict-facilities-add',
  standalone: true,
  ...
  templateUrl: './ict-facilities-add.component.html',
  styleUrl: './ict-facilities-add.component.css'
})
export class ICTFacilitiesAddComponent {
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.ICTFacilities);
