...
@Component({
  selector: 'lib-funding-research-edit',
  standalone: true,
  ...
  templateUrl: './funding-research-edit.component.html',
  styleUrl: './funding-research-edit.component.css'
})
export class FundingResearchEditComponent {
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.FundingResearch);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.FundingResearch);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          investigatorName: formData?.investigator_name || '',
          fundingAgencyName: formData?.funding_agency || '',
          type: formData?.type || '',
          departmentName: formData?.department || '',
          awardedYear: formData?.award_year || '',
          fundsProvided: formData?.funds || '',
