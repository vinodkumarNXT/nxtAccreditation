...
@Component({
  selector: 'lib-research-fellowship-add',
  standalone: true,
  ...
  templateUrl: './research-fellowship-add.component.html',
  styleUrl: './research-fellowship-add.component.css'
})
export class ResearchFellowshipAddComponent {
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.ResearchFellowship);
