...
@Component({
  selector: 'lib-research-fellowship-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './research-fellowship-view.component.html',
  styleUrl: './research-fellowship-view.component.css'
})
export class ResearchFellowshipViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.ResearchFellowship);
