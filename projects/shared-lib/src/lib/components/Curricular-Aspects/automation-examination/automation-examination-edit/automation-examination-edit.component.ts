...
@Component({
  selector: 'lib-automation-examination-edit',
  standalone: true,
  ...
  templateUrl: './automation-examination-edit.component.html',
  styleUrl: './automation-examination-edit.component.css'
})
export class AutomationExaminationEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      automationText: ["", Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        automationText: this.form.get("automationText").value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.AutomationExamination);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.AutomationExamination);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          automationText: formData?.text_for_automation,
