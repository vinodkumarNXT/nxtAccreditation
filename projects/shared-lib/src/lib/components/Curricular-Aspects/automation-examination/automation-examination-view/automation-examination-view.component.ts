...
@Component({
  selector: 'lib-automation-examination-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './automation-examination-view.component.html',
  styleUrl: './automation-examination-view.component.css'
})
export class AutomationExaminationViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.AutomationExamination);
