...
export class TrainingProgramsComponent {
  ...
  displayedColumns = ["id", "programTitle","participants", "fromDate","toDate","actions"];
  ...
  async loadFormData() {
    try {
      const listData = await this.formsService.getListData(endpoints.TrainingPrograms);
  ...
  openAddDialog(): void {
    // Open the dialog 
    const dialogRef = this.dialog.open(TrainingProgramsAddComponent, {});
  ...
  viewElement(val: any): void {
    ...
    const dialogRef = this.dialog.open(TrainingProgramsViewComponent, {
  ...
  async editElement(val: any): Promise<void> {
    ...
    const dialogRef = this.dialog.open(TrainingProgramsEditComponent, {
  ...
  async deleteElement(val: any): Promise<void> {
    const id = val.id;
    const endpoint = endpoints.TrainingPrograms;
