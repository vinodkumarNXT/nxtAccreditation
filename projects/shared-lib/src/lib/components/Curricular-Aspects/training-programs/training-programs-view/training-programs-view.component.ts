...
@Component({
  selector: 'lib-training-programs-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './training-programs-view.component.html',
  styleUrl: './training-programs-view.component.css'
})
export class TrainingProgramsViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.TrainingPrograms);
