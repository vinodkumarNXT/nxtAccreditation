...
@Component({
  selector: 'lib-citations-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './citations-view.component.html',
  styleUrl: './citations-view.component.css'
})
export class CitationsViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.CitationIndex);
