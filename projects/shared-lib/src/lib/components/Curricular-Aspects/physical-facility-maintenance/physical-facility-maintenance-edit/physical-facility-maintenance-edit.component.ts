...
@Component({
  selector: 'lib-physical-facility-maintenance-edit',
  standalone: true,
  ...
  templateUrl: './physical-facility-maintenance-edit.component.html',
  styleUrl: './physical-facility-maintenance-edit.component.css'
})
export class PhysicalFacilityMaintenanceEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      budjetAllocated: ['', Validators.required],
      expenditure: ['', Validators.required],
      totalExpenditure: ['', Validators.required],
      academicMaintenance: ['', Validators.required],
      physicalMaintenance: ['', Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        ...
        budjetAllocated: this.form.get("budjetAllocated")?.value,
        expenditure: this.form.get("expenditure")?.value,
        totalExpenditure: this.form.get("totalExpenditure")?.value,
        academicMaintenance: this.form.get("academicMaintenance")?.value,
        physicalMaintenance: this.form.get("physicalMaintenance")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.PhysicalFacilityMaintenance);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.PhysicalFacilityMaintenance);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          year: formData?.year || '',
          budjetAllocated: formData?.budjetAllocated || '',
          totalExpenditure: formData?.totalExpenditure || '',
          expenditure:formData?.expenditure ||'',
          academicMaintenance: formData?.academicMaintenance || '',
          physicalMaintenance: formData?.physicalMaintenance || '',
