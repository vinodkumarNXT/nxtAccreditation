...
@Component({
  selector: 'lib-alumni-contribution-edit',
  standalone: true,
  ...
  templateUrl: './alumni-contribution-edit.component.html',
  styleUrl: './alumni-contribution-edit.component.css'
})

export class AlumniContributionEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      alumniAssociation: ['', Validators.required],
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      ...
      const postData = {
        ...
        alumniAssociation: this.form.get("alumniAssociation")?.value,
        contribution: this.form.get("contribution")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.AlumniContribution);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.AlumniContribution);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          year: formData?.year || '',
          alumniAssociation: formData?.alumniAssociation || '',
