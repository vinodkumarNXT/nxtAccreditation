...
@Component({
  selector: 'lib-competitions-organized-add',
  standalone: true,
  ...
  templateUrl: './competitions-organized-add.component.html',
  styleUrl: './competitions-organized-add.component.css'
})
export class CompetitionsOrganizedAddComponent {
    ...
    async submitForm() {
      ...
      if (this.form.valid) {
        ...
        try {
          const response = await this.formsService.onFormSubmit(postData, endpoints.CompetitionsOrganized);
