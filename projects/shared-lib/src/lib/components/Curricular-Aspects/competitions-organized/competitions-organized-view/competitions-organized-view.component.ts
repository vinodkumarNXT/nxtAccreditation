...
@Component({
  selector: 'lib-competitions-organized-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './competitions-organized-view.component.html',
  styleUrl: './competitions-organized-view.component.css'
})
export class CompetitionsOrganizedViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.CompetitionsOrganized);
