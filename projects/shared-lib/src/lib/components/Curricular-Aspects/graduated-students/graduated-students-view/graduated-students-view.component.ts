...
@Component({
  selector: 'lib-graduated-students-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './graduated-students-view.component.html',
  styleUrl: './graduated-students-view.component.css'
})
export class GraduatedStudentsViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.GraduatedStudents);
