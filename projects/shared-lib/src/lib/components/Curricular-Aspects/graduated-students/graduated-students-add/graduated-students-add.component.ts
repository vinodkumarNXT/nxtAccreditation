...
@Component({
  selector: 'lib-graduated-students-add',
  standalone: true,
  ...
  templateUrl: './graduated-students-add.component.html',
  styleUrl: './graduated-students-add.component.css'
})
export class GraduatedStudentsAddComponent {
    ...
    async submitForm() {
      ...
      if (this.form.valid) {
        ...
        try {
          const response = await this.formsService.onFormSubmit(postData, endpoints.GraduatedStudents);
