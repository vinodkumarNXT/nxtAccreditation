...
@Component({
  selector: 'lib-learning-outcomes-edit',
  standalone: true,
  ...
  templateUrl: './learning-outcomes-edit.component.html',
  styleUrl: './learning-outcomes-edit.component.css'
})
export class LearningOutcomesEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      outcomesText: ["", Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        outcomesText: this.form.get("outcomesText").value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.LearningOutcomes);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.LearningOutcomes);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          ...
          outcomesText: formData?.text_for_learning_outcome || '', 
