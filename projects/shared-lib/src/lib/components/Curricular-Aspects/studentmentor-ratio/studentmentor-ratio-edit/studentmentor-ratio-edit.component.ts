...
@Component({
  selector: 'lib-studentmentor-ratio-edit',
  standalone: true,
  ...
  templateUrl: './studentmentor-ratio-edit.component.html',
  styleUrl: './studentmentor-ratio-edit.component.css'
})
export class StudentmentorRatioEditComponent {
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        ...
        noOfTeachers: this.form.get('noOfTeachers')?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.StudentsMentorRatio);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.StudentsMentorRatio);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          year:formData?.year || '',
          noOfTeachers:formData?.no_of_teachers || '',
