...
@Component({
  selector: 'lib-internet-bandwidth-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './internet-bandwidth-view.component.html',
  styleUrl: './internet-bandwidth-view.component.css'
})
export class InternetBandwidthViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.InternetBandwidth);
