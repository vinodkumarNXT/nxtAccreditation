...
@Component({
  selector: 'lib-research-fellows-add',
  standalone: true,
  imports: [MaterialModule, SharableModule,  YearMonthDayPipe, MatSort],
  providers: [FormsService, provideNativeDateAdapter()],
  templateUrl: './research-fellows-add.component.html',
  styleUrl: './research-fellows-add.component.css'
})
export class ResearchFellowsAddComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      grantAgency: ['', Validators.required],
      documentLink: [''],
    });
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      const postData = {
        enrollmentYear: this.form.get("enrollmentYear")?.value,
        duration: this.form.get("duration")?.value,
        type: this.form.get("type")?.value,
        grantAgency: this.form.get("grantAgency")?.value,
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.ResearchFellow);
