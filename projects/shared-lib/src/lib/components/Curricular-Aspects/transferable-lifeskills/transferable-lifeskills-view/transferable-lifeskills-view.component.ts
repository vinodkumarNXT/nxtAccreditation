...
@Component({
  selector: 'lib-transferable-lifeskills-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './transferable-lifeskills-view.component.html',
  styleUrl: './transferable-lifeskills-view.component.css'
})
export class TransferableLifeskillsViewComponent {
