...
@Component({
  selector: 'lib-gender-equity-edit',
  standalone: true,
  ...
  templateUrl: './gender-equity-edit.component.html',
  styleUrl: './gender-equity-edit.component.css'
})
export class GenderEquityEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      GenderEquity: ['', Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        GenderEquity: this.form.get("GenderEquity")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.GenderEquity);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.GenderEquity);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          GenderEquity: formData?.gender_equity_sensitization || '',
