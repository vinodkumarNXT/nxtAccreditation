...
export class GovtGrantsComponent {
  ...
  openAddDialog(): void {
    // Open the dialog 
    const dialogRef = this.dialog.open(GovtGrantsAddComponent, {});
  ...
  viewElement(val: any): void {
    ...
    const dialogRef = this.dialog.open(GovtGrantsViewComponent, {
  ...
  async editElement(val: any): Promise<void> {
    ...
    const dialogRef = this.dialog.open(GovtGrantsEditComponent, {
  ...
  async deleteElement(val: any): Promise<void> {
    const id = val.id;
    const endpoint = endpoints.GovtGrants;
