...
@Component({
  selector: 'lib-reserved-category-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './reserved-category-view.component.html',
  styleUrl: './reserved-category-view.component.css'
})
export class ReservedCategoryViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.ReservedCategory);
