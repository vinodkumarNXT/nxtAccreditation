...
@Component({
  selector: 'lib-reserved-category-edit',
  standalone: true,
  ...
  templateUrl: './reserved-category-edit.component.html',
  styleUrl: './reserved-category-edit.component.css'
})
export class ReservedCategoryEditComponent {
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.ReservedCategory);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.ReservedCategory);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          ...
          year:formData.year || '',
          noOfSeatsReserved:formData.no_of_seats_reserved || '',
