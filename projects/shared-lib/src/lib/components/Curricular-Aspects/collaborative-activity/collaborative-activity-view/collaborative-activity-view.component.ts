...
@Component({
  selector: 'lib-collaborative-activity-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './collaborative-activity-view.component.html',
  styleUrl: './collaborative-activity-view.component.css'
})
export class CollaborativeActivityViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.CollaborativeActivity);
