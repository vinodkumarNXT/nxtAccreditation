...
@Component({
  selector: 'lib-placement-percentage-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './placement-percentage-view.component.html',
  styleUrl: './placement-percentage-view.component.css'
})
export class PlacementPercentageViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.PlacementPercentage);
