...
@Component({
  selector: 'lib-placement-percentage-add',
  standalone: true,
  ...
  templateUrl: './placement-percentage-add.component.html',
  styleUrl: './placement-percentage-add.component.css'
})
export class PlacementPercentageAddComponent {
    ...
    async submitForm() {
      ...
      if (this.form.valid) {
        ...
        try {
          const response = await this.formsService.onFormSubmit(postData, endpoints.PlacementPercentage);
