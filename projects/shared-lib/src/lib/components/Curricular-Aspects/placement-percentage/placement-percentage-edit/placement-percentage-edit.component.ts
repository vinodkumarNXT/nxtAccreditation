...
@Component({
  selector: 'lib-placement-percentage-edit',
  standalone: true,
  ...
  templateUrl: './placement-percentage-edit.component.html',
  styleUrl: './placement-percentage-edit.component.css'
})
export class PlacementPercentageEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      passedoutStudentCount: ['', Validators.required],
      placedStudentcount: ['', Validators.required],
      placedCompany: ['', Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
    ...
    if (this.form.valid) {
      const postData = {
        year: this.form.get("year")?.value,
          passedoutStudentCount: this.form.get("passedoutStudentCount")?.value,
          placedStudentcount: this.form.get("placedStudentcount")?.value,
          placedCompany: this.form.get("placedCompany")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.PlacementPercentage);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.PlacementPercentage);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          year: formData?.year || '',
          passedoutStudentCount: formData?.passedoutStudentCount || '',
          placedStudentcount: formData?.placedStudentcount || '',
