...
@Component({
  selector: 'lib-infrastracture-expenditure-edit',
  standalone: true,
  ...
  templateUrl: './infrastracture-expenditure-edit.component.html',
  styleUrl: './infrastracture-expenditure-edit.component.css'
})
export class InfrastractureExpenditureEditComponent {
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.InfrastractureExpenditure);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.InfrastractureExpenditure);
