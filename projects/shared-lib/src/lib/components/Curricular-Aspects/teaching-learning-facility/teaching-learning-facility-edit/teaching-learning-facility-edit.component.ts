...
@Component({
  selector: 'lib-teaching-learning-facility-edit',
  standalone: true,
  ...
  templateUrl: './teaching-learning-facility-edit.component.html',
  styleUrl: './teaching-learning-facility-edit.component.css'
})
export class TeachingLearningFacilityEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      teachingLearning: ['', Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        teachingLearningText: this.form.get("teachingLearning")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.TeachingLearningFacility);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.TeachingLearningFacility);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          teachingLearning: formData?.teachingLearningText || '',
