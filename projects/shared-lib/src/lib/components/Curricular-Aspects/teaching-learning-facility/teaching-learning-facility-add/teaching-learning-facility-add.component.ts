...
@Component({
  selector: 'lib-teaching-learning-facility-add',
  standalone: true,
  ...
  templateUrl: './teaching-learning-facility-add.component.html',
  styleUrl: './teaching-learning-facility-add.component.css'
})
export class TeachingLearningFacilityAddComponent {
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.TeachingLearningFacility);
