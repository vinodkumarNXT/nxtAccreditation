...
@Component({
  selector: 'lib-teaching-learning-facility-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './teaching-learning-facility-view.component.html',
  styleUrl: './teaching-learning-facility-view.component.css'
})
export class TeachingLearningFacilityViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.TeachingLearningFacility);
