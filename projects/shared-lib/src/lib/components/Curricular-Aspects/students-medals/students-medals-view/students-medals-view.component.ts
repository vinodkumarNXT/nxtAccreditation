...
@Component({
  selector: 'lib-students-medals-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './students-medals-view.component.html',
  styleUrl: './students-medals-view.component.css'
})
export class StudentsMedalsViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.StudentsMedals);
