...
@Component({
  selector: 'lib-students-medals-edit',
  standalone: true,
  ...
  templateUrl: './students-medals-edit.component.html',
  styleUrl: './students-medals-edit.component.css'
})

export class StudentsMedalsEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      teamIndividual: ['', Validators.required],
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        ...
        teamIndividual: this.form.get("teamIndividual")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.StudentsMedals);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.StudentsMedals);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          ...
          teamIndividual: formData?.teamIndividual || '',
