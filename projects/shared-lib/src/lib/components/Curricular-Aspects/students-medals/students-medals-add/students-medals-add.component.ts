...
@Component({
  selector: 'lib-students-medals-add',
  standalone: true,
  ...
  templateUrl: './students-medals-add.component.html',
  styleUrl: './students-medals-add.component.css'
})
export class StudentsMedalsAddComponent {
    ...
    async submitForm() {
      ...
      if (this.form.valid) {
        ...
        try {
          const response = await this.formsService.onFormSubmit(postData, endpoints.StudentsMedals);
