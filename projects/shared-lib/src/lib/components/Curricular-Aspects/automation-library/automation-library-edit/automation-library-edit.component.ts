...
@Component({
  selector: 'lib-automation-library-edit',
  standalone: true,
  ...
  templateUrl: './automation-library-edit.component.html',
  styleUrl: './automation-library-edit.component.css'
})
export class AutomationLibraryEditComponent {
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        automationText: this.form.get("automation")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.AutomationLibrary);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.AutomationLibrary);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          automation: formData?.automationText || '',
