...
@Component({
  selector: 'lib-research-projects-add',
  standalone: true,
  ...
  templateUrl: './research-projects-add.component.html',
  styleUrl: './research-projects-add.component.css'
})
export class ResearchProjectsAddComponent {
...
//             'qualificationYear' => 'required',
//             'researchGuide' => 'required',
//             'guideRecognitionYear' => 'required',
//             'currentstatus' => 'required',
//             'scholarName' => 'required',
//             'guideLetterLink' => 'required',
//             'scholarRegistrationYear' => 'required'
// 'fileUpload'
//       'documentLink'"
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.ResearchProjects);
  ...
  async loadFormData() {
    try {
      ...
      const listData = await this.formsService.getListData(endpoints.ResearchProjects);
