...
import { MaterialModule, SharableModule,  YearMonthDayPipe, FormsService, FileUploadService, SwalService, TablePaginationService, LibraryExpenditureAddComponent, LibraryExpenditureViewComponent, LibraryExpenditureEditComponent, LibraryUsersAddComponent, LibraryUsersViewComponent, LibraryUsersEditComponent } from 'shared-lib';
import Swal from 'sweetalert2';

@Component({
  selector: 'lib-library-users',
  standalone: true,
...
export class LibraryUsersComponent {
  ...
  displayedColumns = ["id", "onlineLoginCount","eAccessUserCount", "physicalUserCount","actions"];
  
//   {
//     "id": 1,
//     "onlineLoginCount": "20",
//     "eAccessUserCount": "30",
//     "physicalUserCount": "50",
//     "uploadFiles": [
//         "1726723201_Screenshot_(8).png",
//         "1726723201_Screenshot_(8).png"
//     ],
//     "documentLinks": "test"
// }
  ...
  openAddDialog(): void {
    // Open the dialog 
    const dialogRef = this.dialog.open(LibraryUsersAddComponent, {});
  ...
  viewElement(val: any): void {
    ...
    const dialogRef = this.dialog.open(LibraryUsersViewComponent, {
  ...
  async editElement(val: any): Promise<void> {
    ...
    const dialogRef = this.dialog.open(LibraryUsersEditComponent, {
  ...
  async deleteElement(val: any): Promise<void> {
    const id = val.id;
    const endpoint = endpoints.LibraryUsers;
