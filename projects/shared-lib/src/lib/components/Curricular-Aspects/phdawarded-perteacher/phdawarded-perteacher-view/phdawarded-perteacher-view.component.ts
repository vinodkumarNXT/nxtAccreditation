...
@Component({
  selector: 'lib-phdawarded-perteacher-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './phdawarded-perteacher-view.component.html',
  styleUrl: './phdawarded-perteacher-view.component.css'
})
export class PhdawardedPerteacherViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.PhdAwardedPerTeacher);
