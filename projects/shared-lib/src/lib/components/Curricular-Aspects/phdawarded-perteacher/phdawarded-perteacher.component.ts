...
export class PhdawardedPerteacherComponent {


  pageSizeOptions: number[] = [];
  displayedColumns = ["id", "phdScholarName", "departmentName", "guideName", "registrationYear","actions"];
  ...
  openAddDialog(): void {
    // Open the dialog 
    const dialogRef = this.dialog.open(PhdawardedPerteacherAddComponent, {});
  ...
  viewElement(val: any): void {
    ...
    const dialogRef = this.dialog.open(PhdawardedPerteacherViewComponent, {
  ...
  async editElement(val: any): Promise<void> {
    ...
    const dialogRef = this.dialog.open(PhdawardedPerteacherEditComponent, {
  ...
  async deleteElement(val: any): Promise<void> {
    const id = val.id;
    const endpoint = endpoints.PhdAwardedPerTeacher;
