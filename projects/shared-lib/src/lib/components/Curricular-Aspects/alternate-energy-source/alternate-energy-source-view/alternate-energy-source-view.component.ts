...
@Component({
  selector: 'lib-alternate-energy-source-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './alternate-energy-source-view.component.html',
  styleUrl: './alternate-energy-source-view.component.css'
})
export class AlternateEnergySourceViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.AlternateEnergySource);
