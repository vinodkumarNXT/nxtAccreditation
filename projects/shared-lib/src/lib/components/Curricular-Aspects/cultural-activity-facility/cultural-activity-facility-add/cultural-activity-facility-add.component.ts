...
@Component({
  selector: 'lib-cultural-activity-facility-add',
  standalone: true,
  imports: [MaterialModule, SharableModule,  YearMonthDayPipe, MatSort],
  providers: [FormsService, provideNativeDateAdapter()],
  templateUrl: './cultural-activity-facility-add.component.html',
  styleUrl: './cultural-activity-facility-add.component.css'
})
export class CulturalActivityFacilityAddComponent {
