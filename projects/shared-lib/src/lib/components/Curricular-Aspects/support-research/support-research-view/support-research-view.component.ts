...
@Component({
  selector: 'lib-support-research-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './support-research-view.component.html',
  styleUrl: './support-research-view.component.css'
})
export class SupportResearchViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.SupportResearch);
