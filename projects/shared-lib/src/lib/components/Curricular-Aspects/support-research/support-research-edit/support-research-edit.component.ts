...
@Component({
  selector: 'lib-support-research-edit',
  standalone: true,
  ...
  templateUrl: './support-research-edit.component.html',
  styleUrl: './support-research-edit.component.css'
})
export class SupportResearchEditComponent {
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.SupportResearch);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.SupportResearch);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          supportResearch: formData?.support_research || '',
