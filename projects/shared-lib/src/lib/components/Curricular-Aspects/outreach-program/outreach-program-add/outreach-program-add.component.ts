...
export class OutreachProgramAddComponent {
  ...
  //   'organizingUnit' => 'required',
  //    'schemeName' => 'required',
  //      'activityYear' => 'required',
...
async submitForm() {
  ...
  if (this.form.valid) {
    ...
    try {
      const response = await this.formsService.onFormSubmit(postData, endpoints.OutreachProgram);
