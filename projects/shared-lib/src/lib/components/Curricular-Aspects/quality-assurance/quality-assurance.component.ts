...
export class QualityAssuranceComponent {
  ...
  displayedColumns = ["id", "initiative","actions"];
  ...
  async loadFormData() {
    try {
      const listData = await this.formsService.getListData(endpoints.QualityAssurance);
  ...
  openAddDialog(): void {
    // Open the dialog 
    const dialogRef = this.dialog.open(QualityAssuranceAddComponent, {});
  ...
  viewElement(val: any): void {
    ...
    const dialogRef = this.dialog.open(QualityAssuranceViewComponent, {
  ...
  async editElement(val: any): Promise<void> {
    ...
    const dialogRef = this.dialog.open(QualityAssuranceEditComponent, {
  ...
  async deleteElement(val: any): Promise<void> {
    const id = val.id;
    const endpoint = endpoints.QualityAssurance;
