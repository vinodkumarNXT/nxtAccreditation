...
@Component({
  selector: 'lib-quality-assurance-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './quality-assurance-view.component.html',
  styleUrl: './quality-assurance-view.component.css'
})
export class QualityAssuranceViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.QualityAssurance);
