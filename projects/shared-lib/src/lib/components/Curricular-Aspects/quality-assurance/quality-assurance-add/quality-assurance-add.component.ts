...
@Component({
  selector: 'lib-quality-assurance-add',
  standalone: true,
  ...
  templateUrl: './quality-assurance-add.component.html',
  styleUrl: './quality-assurance-add.component.css'
})
export class QualityAssuranceAddComponent {
    ...
    async submitForm() {
      ...
      if (this.form.valid) {
        ...
        try {
          const response = await this.formsService.onFormSubmit(postData, endpoints.QualityAssurance);
