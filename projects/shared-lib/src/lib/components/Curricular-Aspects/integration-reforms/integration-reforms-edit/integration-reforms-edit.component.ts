...
@Component({
  selector: 'lib-integration-reforms-edit',
  standalone: true,
  ...
  templateUrl: './integration-reforms-edit.component.html',
  styleUrl: './integration-reforms-edit.component.css'
})
export class IntegrationReformsEditComponent {
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        integrationText: this.form.get("integrationText").value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.IntegrationReforms);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.IntegrationReforms);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          integrationText: formData?.text_for_integration|| "",
