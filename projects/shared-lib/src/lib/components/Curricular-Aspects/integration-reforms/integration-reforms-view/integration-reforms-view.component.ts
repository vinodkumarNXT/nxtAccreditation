...
@Component({
  selector: 'lib-integration-reforms-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './integration-reforms-view.component.html',
  styleUrl: './integration-reforms-view.component.css'
})
export class IntegrationReformsViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.IntegrationReforms);
