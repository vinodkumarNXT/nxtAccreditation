...
@Component({
  selector: 'lib-extension-activity-edit',
  standalone: true,
  ...
  templateUrl: './extension-activity-edit.component.html',
  styleUrl: './extension-activity-edit.component.css'
})
export class ExtensionActivityEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      socialIssue: ['', Validators.required],
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        socialIssue: this.form.get("socialIssue")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.ExtensionActivity);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.ExtensionActivity);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          socialIssue: formData?.socialIssue || '',
          year: formData?.year || '',
