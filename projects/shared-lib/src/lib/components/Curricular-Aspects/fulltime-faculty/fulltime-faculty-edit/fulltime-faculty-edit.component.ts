...
@Component({
  selector: 'lib-fulltime-faculty-edit',
  standalone: true,
  ...
  templateUrl: './fulltime-faculty-edit.component.html',
  styleUrl: './fulltime-faculty-edit.component.css'
})
export class FulltimeFacultyEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      appointedYear: ["", Validators.required],
      appointementType: ["", Validators.required],
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        ...
        appointedYear: this.form.get("appointedYear").value,
        appointementType: this.form.get("appointementType").value,
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.FullTimeFaculty);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          ...
          appointedYear: formData?.appointed_year,
          appointementType: formData?.appointement_type,
