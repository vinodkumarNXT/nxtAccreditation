...
@Component({
  selector: 'lib-fulltime-faculty-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './fulltime-faculty-view.component.html',
  styleUrl: './fulltime-faculty-view.component.css'
})
export class FulltimeFacultyViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.FullTimeFaculty);
