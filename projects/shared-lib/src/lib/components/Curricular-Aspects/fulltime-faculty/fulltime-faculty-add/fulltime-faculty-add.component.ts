...
@Component({
  selector: 'lib-fulltime-faculty-add',
  standalone: true,
  ...
  templateUrl: './fulltime-faculty-add.component.html',
  styleUrl: './fulltime-faculty-add.component.css'
})
export class FulltimeFacultyAddComponent {
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.FullTimeFaculty);
