...
@Component({
  selector: 'lib-scholarship-schemes-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './scholarship-schemes-view.component.html',
  styleUrl: './scholarship-schemes-view.component.css'
})
export class ScholarshipSchemesViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.ScholarshipSchemes);
