...
@Component({
  selector: 'lib-scholarship-schemes-add',
  standalone: true,
  ...
  templateUrl: './scholarship-schemes-add.component.html',
  styleUrl: './scholarship-schemes-add.component.css'
})
export class ScholarshipSchemesAddComponent {
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.ScholarshipSchemes);
