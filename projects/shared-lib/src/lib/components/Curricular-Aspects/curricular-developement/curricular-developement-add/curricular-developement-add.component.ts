...
@Component({
  selector: 'lib-curricular-developement-add',
  standalone: true,
  ...
  templateUrl: './curricular-developement-add.component.html',
  styleUrl: './curricular-developement-add.component.css'
})
export class CurricularDevelopementAddComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      uploadLinks: ['', Validators.required],
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.CirDesignAndDevelopment);
