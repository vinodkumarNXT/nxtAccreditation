...
@Component({
  selector: 'lib-research-facility-edit',
  standalone: true,
  ...
  templateUrl: './research-facility-edit.component.html',
  styleUrl: './research-facility-edit.component.css'
})
export class ResearchFacilityEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      researchText: ["", Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        researchText: this.form.get("researchText").value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.ResearchFacility);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.ResearchFacility);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          ...
          researchText: formData?.research_facility || '',
