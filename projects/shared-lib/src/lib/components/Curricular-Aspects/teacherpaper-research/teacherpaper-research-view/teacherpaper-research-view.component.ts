...
@Component({
  selector: 'lib-teacherpaper-research-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './teacherpaper-research-view.component.html',
  styleUrl: './teacherpaper-research-view.component.css'
})
export class TeacherpaperResearchViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.TeacherResearchPapers);
