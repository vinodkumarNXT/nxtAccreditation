...
@Component({
  selector: 'lib-consultancy-revenue-edit',
  standalone: true,
  ...
  templateUrl: './consultancy-revenue-edit.component.html',
  styleUrl: './consultancy-revenue-edit.component.css'
})
export class ConsultancyRevenueEditComponent {
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        staffName: this.form.get("staffName")?.value,
        departmentName: this.form.get("departmentName")?.value,
        agencyName: this.form.get("agencyName")?.value,
        year: this.form.get("year")?.value,
        consultancyName: this.form.get("consultancyName")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.ConsultancyRevenue);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.ConsultancyRevenue);
