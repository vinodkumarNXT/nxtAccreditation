...
@Component({
  selector: 'lib-teacher-econtent-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './teacher-econtent-view.component.html',
  styleUrl: './teacher-econtent-view.component.css'
})
export class TeacherEcontentViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.TeacherEcontent);
