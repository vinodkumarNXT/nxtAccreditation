...
@Component({
  selector: 'lib-participative-management-edit',
  standalone: true,
  ...
  templateUrl: './participative-management-edit.component.html',
  styleUrl: './participative-management-edit.component.css'
})

export class ParticipativeManagementEditComponent {
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        management: this.form.get("management")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.ParticipativeManagement);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.ParticipativeManagement);
