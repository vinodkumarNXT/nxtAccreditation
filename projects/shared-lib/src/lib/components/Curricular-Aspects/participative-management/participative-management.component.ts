...
@Component({
  ...
  templateUrl: './participative-management.component.html',
  styleUrl: './participative-management.component.css'
})
export class ParticipativeManagementComponent {


  pageSizeOptions: number[] = [];
  displayedColumns = ["id", "management","actions"];
  ...
  async loadFormData() {
    try {
      const listData = await this.formsService.getListData(endpoints.ParticipativeManagement);
  ...
  openAddDialog(): void {
    // Open the dialog 
    const dialogRef = this.dialog.open(ParticipativeManagementAddComponent, {});
  ...
  viewElement(val: any): void {
    ...
    const dialogRef = this.dialog.open(ParticipativeManagementViewComponent, {
  ...
  async editElement(val: any): Promise<void> {
    ...
    const dialogRef = this.dialog.open(ParticipativeManagementEditComponent, {
  ...
  async deleteElement(val: any): Promise<void> {
    const id = val.id;
    const endpoint = endpoints.ParticipativeManagement;
