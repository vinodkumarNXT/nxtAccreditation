...
@Component({
  selector: 'lib-seminars-conducted-edit',
  standalone: true,
  ...
  templateUrl: './seminars-conducted-edit.component.html',
  styleUrl: './seminars-conducted-edit.component.css'
})
export class SeminarsConductedEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      activityLink: ['', Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        ...
        activityLink: this.form.get("activityLink")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.SeminarsConducted);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.SeminarsConducted);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          ...
          date: formData?.date || '',
          activity_link: formData?.activity_link || '',
