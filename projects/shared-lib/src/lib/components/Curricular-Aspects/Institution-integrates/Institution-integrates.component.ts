...
@Component({
  selector: 'app-Institution-integrates',
...
openAddDialog(): void {
  // Open the dialog 
  const dialogRef = this.dialog.open(InstitutionIntegratesAddComponent, {});
...
viewElement(val: any): void {
  ...
  const dialogRef = this.dialog.open(InstitutionIntegratesViewComponent, {
