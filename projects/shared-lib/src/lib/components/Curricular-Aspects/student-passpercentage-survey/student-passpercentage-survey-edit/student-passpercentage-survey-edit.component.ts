...
@Component({
  selector: 'lib-student-passpercentage-survey-edit',
  standalone: true,
  ...
  templateUrl: './student-passpercentage-survey-edit.component.html',
  styleUrl: './student-passpercentage-survey-edit.component.css'
})
export class StudentPasspercentageSurveyEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      studentsAppeared: ['', Validators.required],
      studentsPassed: ['', Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        ...
        studentsAppeared: this.form.get("studentsAppeared")?.value,
        studentsPassed: this.form.get("studentsPassed")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.StudentPassPercentageSurvey);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.StudentPassPercentageSurvey);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          ...
          programCode: formData?.programe_code || '',
          studentsAppeared: formData?.students_appeared || '',
          studentsPassed: formData?.students_passed || '',
