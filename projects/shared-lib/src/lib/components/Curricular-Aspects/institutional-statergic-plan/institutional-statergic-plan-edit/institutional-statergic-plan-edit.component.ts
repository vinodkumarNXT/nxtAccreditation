...
@Component({
  selector: 'lib-institutional-statergic-plan-edit',
  standalone: true,
  ...
  templateUrl: './institutional-statergic-plan-edit.component.html',
  styleUrl: './institutional-statergic-plan-edit.component.css'
})

export class InstitutionalStatergicPlanEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      strategicPlan: ['', Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        strategicPlan: this.form.get("strategicPlan")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.InstitutionalStatergicPlan);
