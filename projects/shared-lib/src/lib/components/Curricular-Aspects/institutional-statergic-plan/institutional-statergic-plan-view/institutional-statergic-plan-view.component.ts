...
@Component({
  selector: 'lib-institutional-statergic-plan-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './institutional-statergic-plan-view.component.html',
  styleUrl: './institutional-statergic-plan-view.component.css'
})
export class InstitutionalStatergicPlanViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.InstitutionalStatergicPlan);
