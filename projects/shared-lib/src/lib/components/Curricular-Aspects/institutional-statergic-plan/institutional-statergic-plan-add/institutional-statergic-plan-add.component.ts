...
@Component({
  selector: 'lib-institutional-statergic-plan-add',
  standalone: true,
  ...
  templateUrl: './institutional-statergic-plan-add.component.html',
  styleUrl: './institutional-statergic-plan-add.component.css'
})
export class InstitutionalStatergicPlanAddComponent {
    ...
    async submitForm() {
      ...
      if (this.form.valid) {
        ...
        try {
          const response = await this.formsService.onFormSubmit(postData, endpoints.InstitutionalStatergicPlan);
