...
@Component({
  selector: 'lib-recognition-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './recognition-view.component.html',
  styleUrl: './recognition-view.component.css'
})
export class RecognitionViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.Recognition);
