...
@Component({
  ...
  templateUrl: './recognition-edit.component.html',
  styleUrl: './recognition-edit.component.css'
})
export class RecognitionEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      awardDuration: ['', Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        ...
        awardDuration: this.form.get("awardDuration")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.Recognition);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.Recognition);
