...
@Component({
  selector: 'lib-non-govt-grants-add',
  standalone: true,
  ...
  templateUrl: './non-govt-grants-add.component.html',
  styleUrl: './non-govt-grants-add.component.css'
})
export class NonGovtGrantsAddComponent {
    ...
    async submitForm() {
      ...
      if (this.form.valid) {
        ...
        try {
          const response = await this.formsService.onFormSubmit(postData, endpoints.NonGovtGrants);
