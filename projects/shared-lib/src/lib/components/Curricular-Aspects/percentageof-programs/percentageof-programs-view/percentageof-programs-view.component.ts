...
import { FormsService, MaterialModule, PercentageofProgramsEditComponent, SharableModule } from 'shared-lib';
import { endpoints } from 'projects/shell/environments/endpoint';
import { RandomColorService } from 'school-erp-public';
import Swal from 'sweetalert2';

@Component({
  selector: 'lib-percentageof-programs-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './percentageof-programs-view.component.html',
  styleUrl: './percentageof-programs-view.component.css'
})
export class PercentageofProgramsViewComponent {
