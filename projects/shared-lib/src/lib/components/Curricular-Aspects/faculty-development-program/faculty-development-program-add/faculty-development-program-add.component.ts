...
@Component({
  selector: 'lib-faculty-development-program-add',
  standalone: true,
  ...
  templateUrl: './faculty-development-program-add.component.html',
  styleUrl: './faculty-development-program-add.component.css'
})
export class FacultyDevelopmentProgramAddComponent {
    ...
    async submitForm() {
      ...
      if (this.form.valid) {
        ...
        try {
          const response = await this.formsService.onFormSubmit(postData, endpoints.FacultyDevelopmentProgram);
