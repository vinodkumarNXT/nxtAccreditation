...
@Component({
  ...
  styleUrl: './faculty-development-program.component.css'
})
export class FacultyDevelopmentProgramComponent {


  pageSizeOptions: number[] = [];
  displayedColumns = ["id", "teacherName","programTitle", "fromDate","toDate","actions"];
  ...
  async loadFormData() {
    try {
      const listData = await this.formsService.getListData(endpoints.FacultyDevelopmentProgram);
  ...
  openAddDialog(): void {
    // Open the dialog 
    const dialogRef = this.dialog.open(FacultyDevelopmentProgramAddComponent, {});
  ...
  viewElement(val: any): void {
    ...
    const dialogRef = this.dialog.open(FacultyDevelopmentProgramViewComponent, {
  ...
  async editElement(val: any): Promise<void> {
    ...
    const dialogRef = this.dialog.open(FacultyDevelopmentProgramEditComponent, {
  ...
  async deleteElement(val: any): Promise<void> {
    const id = val.id;
    const endpoint = endpoints.FacultyDevelopmentProgram;
