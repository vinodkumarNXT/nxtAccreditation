...
export class IncrementalImprovementsComponent {

  pageSizeOptions: number[] = [];
  displayedColumns = ["id", "qualityInitiative","actions"];
  ...
  openAddDialog(): void {
    // Open the dialog 
    const dialogRef = this.dialog.open(IncrementalImprovementsAddComponent, {});
  ...
  viewElement(val: any): void {
    ...
    const dialogRef = this.dialog.open(IncrementalImprovementsViewComponent, {
  ...
  async editElement(val: any): Promise<void> {
    ...
    const dialogRef = this.dialog.open(IncrementalImprovementsEditComponent, {
  ...
  async deleteElement(val: any): Promise<void> {
    const id = val.id;
    const endpoint = endpoints.IncrementalImprovements;
