...
@Component({
  selector: 'lib-learning-process-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './learning-process-view.component.html',
  styleUrl: './learning-process-view.component.css'
})
export class LearningProcessViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.LearningProcess)
