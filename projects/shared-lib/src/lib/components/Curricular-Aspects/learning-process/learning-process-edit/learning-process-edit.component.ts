...
@Component({
  selector: 'lib-learning-process-edit',
  standalone: true,
  ...
  templateUrl: './learning-process-edit.component.html',
  styleUrl: './learning-process-edit.component.css'
})
export class LearningProcessEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ictEnabledTools: ['', Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        ictEnabledTools: this.form.get('ictEnabledTools')?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.LearningProcess);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.LearningProcess);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          ictEnabledTools:formData.ict_enable_tools || '',
