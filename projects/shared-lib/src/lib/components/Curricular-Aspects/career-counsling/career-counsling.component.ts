...
export class CareerCounslingComponent {

  pageSizeOptions: number[] = [];
  displayedColumns = ["id", "schemeName","govtStudent", "govtStudentAmount","institutionStudents","ngoStudent","actions"];
//   {
//     "id": 1,
//     "Year": "2021",
//     "schemeName": "test",
//     "govtStudent": 0,
//     "govtStudentAmount": "20000.00",
//     "institutionStudents": 20,
//     "institutionStudentsAmount": "30000.00",
//     "ngoStudent": 0,
//     "ngoStudentAmount": "10000.00",
//     "ngoName": "test",
//     "uploadFiles": [
//         "1726739422_Screenshot_(8).png",
//         "1726739422_Screenshot_(8).png"
//     ],
//     "documentLinks": null
// }
  ...
  openAddDialog(): void {
    // Open the dialog 
    const dialogRef = this.dialog.open(CareerCounslingAddComponent, {});
  ...
  viewElement(val: any): void {
    ...
    const dialogRef = this.dialog.open(CareerCounslingViewComponent, {
  ...
  async editElement(val: any): Promise<void> {
    ...
    const dialogRef = this.dialog.open(CareerCounslingEditComponent, {
  ...
  async deleteElement(val: any): Promise<void> {
    const id = val.id;
    const endpoint = endpoints.CareerCounseling;
