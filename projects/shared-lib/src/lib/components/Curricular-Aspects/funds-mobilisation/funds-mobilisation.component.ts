...
@Component({
  ...
  templateUrl: './funds-mobilisation.component.html',
  styleUrl: './funds-mobilisation.component.css'
})
export class FundsMobilisationComponent {


  pageSizeOptions: number[] = [];
  displayedColumns = ["id", "resourceMobilisation","actions"];
  ...
  async loadFormData() {
    try {
      const listData = await this.formsService.getListData(endpoints.FundsMobilisation);
  ...
  openAddDialog(): void {
    // Open the dialog 
    const dialogRef = this.dialog.open(FundsMobilisationAddComponent, {});
  ...
  viewElement(val: any): void {
    ...
    const dialogRef = this.dialog.open(FundsMobilisationViewComponent, {
  ...
  async editElement(val: any): Promise<void> {
    ...
    const dialogRef = this.dialog.open(FundsMobilisationEditComponent, {
  ...
  async deleteElement(val: any): Promise<void> {
    const id = val.id;
    const endpoint = endpoints.FundsMobilisation;
