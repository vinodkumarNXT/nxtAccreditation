...
@Component({
  selector: 'lib-funds-mobilisation-add',
  standalone: true,
  ...
  templateUrl: './funds-mobilisation-add.component.html',
  styleUrl: './funds-mobilisation-add.component.css'
})
export class FundsMobilisationAddComponent {
    ...
    async submitForm() {
      ...
      if (this.form.valid) {
        ...
        try {
          const response = await this.formsService.onFormSubmit(postData, endpoints.FundsMobilisation);
