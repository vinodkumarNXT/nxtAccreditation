...
@Component({
  selector: 'lib-capacity-development-edit',
  standalone: true,
  imports: [MaterialModule, SharableModule,  YearMonthDayPipe, MatSort],
  providers: [FormsService, provideNativeDateAdapter()],
  templateUrl: './capacity-development-edit.component.html',
  styleUrl: './capacity-development-edit.component.css'
})
export class CapacityDevelopmentEditComponent {
