...
@Component({
  selector: 'lib-average-percentage-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './average-percentage-view.component.html',
  styleUrl: './average-percentage-view.component.css'
})
export class AveragePercentageViewComponent {
