...
@Component({
  selector: 'lib-teacher-research-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './teacher-research-view.component.html',
  styleUrl: './teacher-research-view.component.css'
})
export class TeacherResearchViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.TeacherResearch);
