...
@Component({
  selector: 'lib-teacher-research-edit',
  standalone: true,
  ...
  templateUrl: './teacher-research-edit.component.html',
  styleUrl: './teacher-research-edit.component.css'
})
export class TeacherResearchEditComponent {
  ...
  constructor(
    ...
    this.form = this.formBuilder.group({
      ...
      policyDocumentLink: ['', Validators.required],
      documentLink: [''],
    });
  }
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        ...
        seedMoney: this.form.get("seedMoney")?.value,
        year: this.form.get("year")?.value,
        policyDocumentLink: this.form.get("policyDocumentLink")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.TeacherResearch);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.TeacherResearch);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          ...
          seedMoney: formData?.seed_money || '',
          year: formData?.year || '',
          policyDocumentLink: formData?.policy_document_link || '',
