...
@Component({
  selector: 'lib-finacial-support-add',
  standalone: true,
  ...
  templateUrl: './finacial-support-add.component.html',
  styleUrl: './finacial-support-add.component.css'
})
export class FinacialSupportAddComponent {
    ...
    async submitForm() {
      ...
      if (this.form.valid) {
        ...
        try {
          const response = await this.formsService.onFormSubmit(postData, endpoints.TeacherFinacialSupport);
