...
@Component({
  selector: 'lib-finacial-support-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './finacial-support-view.component.html',
  styleUrl: './finacial-support-view.component.css'
})
export class FinacialSupportViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.TeacherFinacialSupport);
