...
@Component({
  selector: 'lib-edited-volumes-add',
  standalone: true,
  ...
  templateUrl: './edited-volumes-add.component.html',
  styleUrl: './edited-volumes-add.component.css'
})
export class EditedVolumesAddComponent {
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.EditedVolumes);
