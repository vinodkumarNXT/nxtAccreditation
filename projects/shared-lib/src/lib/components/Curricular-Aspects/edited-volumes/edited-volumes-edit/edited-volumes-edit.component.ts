...
@Component({
  selector: 'lib-edited-volumes-edit',
  standalone: true,
  ...
  templateUrl: './edited-volumes-edit.component.html',
  styleUrl: './edited-volumes-edit.component.css'
})
export class EditedVolumesEditComponent {
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        ...
        bookTitle: this.form.get("bookTitle")?.value,
        publisherName: this.form.get("publisherName")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.EditedVolumes);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.EditedVolumes);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          ...
          issnNumber: formData?.issn_isbn_number || '',
