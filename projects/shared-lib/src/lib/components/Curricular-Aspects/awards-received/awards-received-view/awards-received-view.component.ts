...
@Component({
  selector: 'lib-awards-received-view',
  standalone: true,
  imports: [MaterialModule, SharableModule],
  templateUrl: './awards-received-view.component.html',
  styleUrl: './awards-received-view.component.css'
})
export class AwardsReceivedViewComponent {
 ...
 // Implementation  Load Form  Start Here
   async loadFormData() {
     try {
       const formData = await this.formsService.getFormData(this.data.id, endpoints.AwardsReceived);
