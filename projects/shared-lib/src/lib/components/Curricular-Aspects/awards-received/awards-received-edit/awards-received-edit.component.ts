...
@Component({
  selector: 'lib-awards-received-edit',
  standalone: true,
  ...
  templateUrl: './awards-received-edit.component.html',
  styleUrl: './awards-received-edit.component.css'
})
export class AwardsReceivedEditComponent {
  ...
  */
  async updateForm(): Promise<void> {
    ...
    if (this.form.valid) {
      const postData = {
        activityName: this.form.get("activityName")?.value,
        awardName: this.form.get("awardName")?.value,
        awardBody: this.form.get("awardBody")?.value,
        awardYear: this.form.get("awardYear")?.value,
      ...
      try {
        ...
        await this.formsService.updateFormData(postData, this.editformID, endpoints.AwardsReceived);
  ...
  async loadFormData(): Promise<void> {
    try {
      const response = await this.formsService.getFormData(this.data.id, endpoints.AwardsReceived);
      ...
      if (response && response.data) {
        ...
        this.form.patchValue({
          ...
          awardBody: formData?.awardBody || '',
          awardYear: formData?.awardYear || '',
