...
@Component({
  selector: 'lib-water-conservation-add',
  standalone: true,
  ...
  templateUrl: './water-conservation-add.component.html',
  styleUrl: './water-conservation-add.component.css'
})
export class WaterConservationAddComponent {
    ...
    form: FormGroup;
      ...
      async submitForm() {
        ...
        if (this.form.valid) {
          ...
          try {
            const response = await this.formsService.onFormSubmit(postData, endpoints.WaterConservation);
