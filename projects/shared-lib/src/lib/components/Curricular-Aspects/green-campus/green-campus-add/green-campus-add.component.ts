...
@Component({
  ...
  templateUrl: './green-campus-add.component.html',
  styleUrl: './green-campus-add.component.css'
})
export class GreenCampusAddComponent {
  ...
  async submitForm() {
    ...
    if (this.form.valid) {
      ...
      try {
        const response = await this.formsService.onFormSubmit(postData, endpoints.GreenCampus);
